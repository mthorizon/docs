...
it, please also see the [Indexer Overview](/api/indexer/01-overview).
...
```
<strong>This code requires an API Access Key from <a href="https://sequence.build"><u>**Sequence Builder**</u></a> </strong>then in your app (using your `API_Access_Key`)
...
The Sequence Indexer is integrated directly inside of the respective [Sequence Web3 Unity](/sdk/unity/01-overview) and [Sequence Web3 Unreal](/sdk/unreal/01-overview) SDKs.
