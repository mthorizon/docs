...
Compile and deploy the contracts in the [Sequence Wallet Context](/solutions/technical-references/wallet-contracts/02-universal-deployer#3---deploy-wallet-context) using the UniversalDeployer2.
