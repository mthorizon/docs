...
This property alongside the use of [SingletonDeployer](/solutions/technical-references/wallet-contracts/02-universal-deployer) or [UniversalDeployer](/solutions/technical-references/wallet-contracts/02-universal-deployer) is the reason why Sequence wallets can obtain the same address on multiple chains.
