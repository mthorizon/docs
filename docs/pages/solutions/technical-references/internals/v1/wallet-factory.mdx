...
This property alongside the use of [SingletonDeployer](#TODO) or [UniversalDeployer](#TODO) is the reason why Sequence wallets can obtain the same address on multiple chains.
