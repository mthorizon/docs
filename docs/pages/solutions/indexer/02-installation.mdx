...
The Sequence Indexer is integrated directly inside of the respective [Sequence Web3 Unity](/sdk/unity/06-read-from-blockchain) and [Sequence Web3 Unreal](/sdk/unreal) SDKs.
