...
Gas limits, prices, and nonce are always handled automatically by the In-Game Wallet.
...
For more details, see [validation](/solutions/wallets/in-game-wallet/examples/validation).
