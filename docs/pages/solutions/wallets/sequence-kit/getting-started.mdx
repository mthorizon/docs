...
## Create Embedded Wallet Connector
...
<Callout type="info">
  Compared to the [Universal default connector approach](/solutions/wallets/sequence-kit/getting-started#create-universal-default-connectors) the Embedded Wallet Connector requires a few more WaaS Authentication configuration options, with benefits in UI/UX.
</Callout>
