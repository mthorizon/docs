...
Alternatively, our quickstart page for [In-Game Wallets](/solutions/wallets/in-game-wallet/quickstart) and [Universal Wallets](/solutions/wallets/universal-wallet/quickstart) has all the templates, demos, and common integration patterns needed to accelerate your development.
