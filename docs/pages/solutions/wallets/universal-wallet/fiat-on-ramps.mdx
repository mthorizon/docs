...
The [Sequence Kit SDK](/sdk/sequence-kit/overview) offers the support for using [Transak](https://transak.com/) to on-ramp users with a fiat credit or debit card using a simplified react hook component.
