...
See [Build With Sequence](/solutions/wallets/universal-wallet/02-quickstart.mdx) to get started.
...
while using standard Ethereum web3 dapp-to-wallet communication. See [Build With Sequence](/solutions/wallets/universal-wallet/02-quickstart.mdx) to get started.
