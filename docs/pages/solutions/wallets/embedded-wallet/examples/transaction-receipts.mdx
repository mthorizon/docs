...
Any methods that involve sending transactions will return either _successful_ or _failed_ transaction receipts. Failed transaction receipts are generated without executing the transaction.
...
To view the full response object, see the [Response payloads](/solutions/wallets/embedded-wallet/implementation-details/response-payloads) section.
...
To view the full response object, see the wallet [Response payloads](/solutions/wallets/embedded-wallet/implementation-details/response-payloads) section.
