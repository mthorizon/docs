...
<Callout type="tip">
  It's a typical pattern to use offchain compute like a cloudflare worker with a relayer wallet sending transactions, which would be inputted in the account field, more on how to accomplish this [here](/guides/templates/mint-collectibles-serverless#mint-collectibles-using-a-gasless-serverless-relayer)
</Callout>
