...
1. Have one generated for you using this [dapp](https://sequence-ethauthproof-viewer.vercel.app/) by selecting your network, and generating a wallet keypair with the `generate local wallet` button
