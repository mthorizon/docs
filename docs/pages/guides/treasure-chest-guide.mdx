...
In the `/src` folder you'll find a `main.tsx`, in there update the code to be the following, that incorporates the Sequence Embedded Wallet SDK
...
And implemented with the previous imported files, in the following code
