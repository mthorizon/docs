...
- [1. Minting](/guides/custom-marketplace-guide#1-minting): Minting of tokens to your wallet from the Sequence Builder
- [2. Wallet authentication](/guides/custom-marketplace-guide#2-wallet-authentication): Use of Sequence Kit to authenticate a user
- [3. Blockchain queries](/guides/custom-marketplace-guide#3-blockchain-queries): Querying of token balances using the Indexer
