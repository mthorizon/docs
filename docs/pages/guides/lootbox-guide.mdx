...
### minting a token
If you want to learn how to deploy a Cloudflare Worker from scratch, you can follow [this default guide](/guides/mint-collectibles-serverless) on minting a severless gasless minter with your deployed `ERC1155` contract
