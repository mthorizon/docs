...
To learn more on how to configure the on-ramp options, see [Sequence Connect Options](/solutions/wallets/universal-wallet/examples/01-connect-wallet#wallet-login-and-connect-options).
