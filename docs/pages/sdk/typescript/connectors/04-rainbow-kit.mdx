...
A more in depth description of the connect options is available [here](/solutions/wallets/universal-wallet/examples/01-connect-wallet#wallet-login-and-connect-options).
