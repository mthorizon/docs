...
A more in depth description of the connect options is available [here](/solutions/wallets/universal-wallet/03-guides/01-connect-wallet#wallet-login-and-connect-options).
...
See [this section](/sdk/typescript/connectors/08-FAQ#how-do-i-use-a-wallet-library-and-connector-with-nextjs-using-the-app-directory-version-13-and-above-only) for an explanation on using Wagmi or Wagmi-based libraries with `app` router.  
...
See [this section](/sdk/typescript/connectors/08-FAQ#how-do-i-use-a-wallet-library-and-connector-with-nextjs-using-the-app-directory-version-13-and-above-only) for an explanation on using Wagmi or Wagmi-based libraries with `pages` router.  
