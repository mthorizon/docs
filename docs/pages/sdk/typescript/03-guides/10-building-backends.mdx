...
If you'd like to use the Sequence's Meta-Transaction capabilities, see [Building Relaying Server with Sequence](/guides/templates/02-building-relaying-server).
