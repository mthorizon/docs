...
The Sequence Unreal In-Game Wallet SDK provides full Sequence [In-Game Wallet](/solutions/wallets/embedded-wallet/01-overview) and [Indexer](/api/indexer/01-overview) integration for games built on the Unreal Framework.
