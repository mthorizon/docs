...
`,e.jsxs(n.ul,{children:[`
`,e.jsx(n.li,{children:e.jsx(n.a,{href:"/api/indexer/fetch-tokens",children:"Fetch all tokens & NFTS in any wallet including all metadata"})}),`
`,e.jsx(n.li,{children:e.jsx(n.a,{href:"/api/indexer/transaction-history",children:"Fetch the transaction history for any wallet address"})}),`
`,e.jsx(n.li,{children:e.jsx(n.a,{href:"/api/indexer/unique-tokens",children:"Fetch all unique tokens in a particular ERC20/721/1155 contract, including total supplies"})}),`
`,e.jsx(n.li,{children:e.jsx(n.a,{href:"/api/indexer/unique-tokens",children:`What is the total token supply of an ERC20 token? What is the total token supply of
all the ERC1155 tokens in a particular contract?`})}),`
`,e.jsx(n.li,{children:e.jsx(n.a,{href:"/api/indexer/transation-history-token-contract",children:"Fetch the transaction history for any token contract address"})}),`
