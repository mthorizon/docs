...
`]}),`
`]}),`
`,s.jsxs(e.strong,{children:["Example: ",s.jsx(e.code,{children:"GetOrderbookOrders"})," of token ids from a collection address on Polygon"]}),`
`,s.jsx(d,{type:"info",children:s.jsxs(e.p,{children:["Note: If using the metadata.properties key to filter, the use of ",s.jsx(e.code,{children:"min"}),` and
`,s.jsx(e.code,{children:"max"})," is required to have orders appear in the query"]})}),`
`,s.jsxs(a,{children:[s.jsx(n,{children:"curl"}),s.jsx(i,{children:s.jsx(e.pre,{className:"shiki shiki-themes github-light github-dark-dimmed",style:{backgroundColor:"#fff","--shiki-dark-bg":"#22272e",color:"#24292e","--shiki-dark":"#adbac7"},tabIndex:"0",children:s.jsxs(e.code,{children:[s.jsxs(e.span,{className:"line",children:[s.jsx(e.span,{style:{color:"#6F42C1","--shiki-dark":"#F69D50"},children:"curl"}),s.jsx(e.span,{style:{color:"#005CC5","--shiki-dark":"#6CB6FF"},children:" --request"}),s.jsx(e.span,{style:{color:"#032F62","--shiki-dark":"#96D0FF"},children:" POST "}),s.jsx(e.span,{style:{color:"#005CC5","--shiki-dark":"#F47067"},children:"\\"})]}),`
...
`,s.jsx(e.span,{className:"line",children:s.jsx(e.span,{style:{color:"#032F62","--shiki-dark":"#96D0FF"},children:"}'"})})]})})}),s.jsx(n,{children:"js"}),s.jsx(i,{children:s.jsx(e.pre,{className:"shiki shiki-themes github-light github-dark-dimmed",style:{backgroundColor:"#fff","--shiki-dark-bg":"#22272e",color:"#24292e","--shiki-dark":"#adbac7"},tabIndex:"0",children:s.jsxs(e.code,{children:[s.jsx(e.span,{className:"line",children:s.jsx(e.span,{style:{color:"#6A737D","--shiki-dark":"#768390"},children:"// Works in both a Webapp (browser) or Node.js:"})}),`
...
`,s.jsxs(e.span,{className:"line",children:[s.jsx(e.span,{style:{color:"#032F62","--shiki-dark":"#96D0FF"},children:'    "https://dev-marketplace-api.sequence.app/polygon/rpc/Marketplace/GetOrderbookOrders"'}),s.jsx(e.span,{style:{color:"#24292E","--shiki-dark":"#ADBAC7"},children:","})]}),`
...
`,s.jsx(e.span,{className:"line",children:s.jsx(e.span,{style:{color:"#24292E","--shiki-dark":"#ADBAC7"},children:"})();"})})]})})}),s.jsx(n,{children:"other"}),s.jsx(i,{children:s.jsxs(e.p,{children:["Please ",s.jsx(e.a,{href:"/support",children:"contact our team"})," for assistance with integrations to another target."]})})]}),`
...
`,s.jsx(e.p,{children:s.jsx(e.img,{src:"/img/marketplace/custom-marketplace-listings.png",alt:"GetOrderbookOrders"})})]})}function j(r={}){const{wrapper:e}={...c(),...r.components};return e?s.jsx(e,{...r,children:s.jsx(l,{...r})}):l(r)}export{j as default,x as frontmatter};
