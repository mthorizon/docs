import{d as i,j as e}from"./index-C9_G5bvZ.js";const l={title:"IWallet Interface Implementations in SequenceEthereum SDK - EthWallet and WaaSToWalletAdapter",description:"Learn how to use SequenceEthereum's Wallet module including EthWallet and WaaSToWalletAdapter."};function n(t){const a={a:"a",code:"code",div:"div",h1:"h1",h2:"h2",h3:"h3",header:"header",p:"p",pre:"pre",...i(),...t.components};return e.jsxs(e.Fragment,{children:[e.jsx(a.header,{children:e.jsxs(a.h1,{id:"wallets",children:["Wallets",e.jsx(a.a,{"aria-hidden":"true",tabIndex:"-1",href:"#wallets",children:e.jsx(a.div,{"data-autolink-icon":!0})})]})}),`
...
`,e.jsx(a.pre,{children:e.jsx(a.code,{className:"language-txt",children:`IWallet eoaWallet = new EOAWallet(); // This will generate a cryptographically random private key
...
`,e.jsx(a.pre,{children:e.jsx(a.code,{className:"language-txt",children:`IWallet sequenceAdapter = new SequenceWalletToEOAWalletAdapter(sequenceWallet);
`})}),`
...
`,e.jsx(a.pre,{children:e.jsx(a.code,{className:"language-txt",children:`Address address = wallet.GetAddress();
`})}),`
...
`,e.jsx(a.pre,{children:e.jsx(a.code,{className:"language-txt",children:`string transactionHash = await wallet.SendTransaction(client, transaction);
`})}),`
...
`,e.jsx(a.pre,{children:e.jsx(a.code,{className:"language-txt",children:`TransactionReceipt receipt = await wallet.SendTransactionAndWaitForReceipt(client, transaction);
`})}),`
...
`,e.jsx(a.pre,{children:e.jsx(a.code,{className:"language-txt",children:`string[] transactionHashes = await wallet.SendTransactionBatch(client, transactions);
`})}),`
...
`,e.jsx(a.pre,{children:e.jsx(a.code,{className:"language-txt",children:`TransactionReceipt[] receipts = await wallet.SendTransactionAndWaitForReceipt(client, transactions);
`})}),`
...
`,e.jsx(a.pre,{children:e.jsx(a.code,{className:"language-txt",children:`string signedMessage = await wallet.SignMessage(message, chainId)
`})}),`
...
`,e.jsx(a.pre,{children:e.jsx(a.code,{className:"language-txt",children:`string signedMessage = await wallet.SignMessage(message, Chain.Polygon.AsString());
`})})]})}function r(t={}){const{wrapper:a}={...i(),...t.components};return a?e.jsx(a,{...t,children:e.jsx(n,{...t})}):n(t)}export{r as default,l as frontmatter};
