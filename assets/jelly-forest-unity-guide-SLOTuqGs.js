...
`]}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-txt",children:`private void Start()
{
...
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-txt",children:`private void Awake()
{
...
`]}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-txt",children:`pnpm install wrangler --save-dev
alias wrangler='./node_modules/.bin/wrangler'
`})}),`
`,e.jsx(n.p,{children:"and login"}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-txt",children:`wrangler login
`})}),`
...
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-txt",children:`private Dictionary<BigInteger, TokenBalance> _tokenBalances = new Dictionary<BigInteger, TokenBalance>();
...
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-txt",children:`private void OnWalletCreated(SequenceWallet wallet)
{
    Wallet = wallet;
...
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-txt",children:`public class CollectibleToken : Coin
{
...
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-txt",children:`public async Task Buy()
{
...
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-txt",children:`SequenceConnector.Instance.AddToTransactionQueue(new PurchaseShopItemQueueableTransaction(this));
`})}),`
