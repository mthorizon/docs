...
`,e.jsxs(n.p,{children:["When social sign in is complete, the ",e.jsx(n.a,{href:"https://github.com/0xsequence/sequence-unity/blob/master/Assets/Sequence/SequenceSDK/Authentication/OpenIdAuthenticator.cs#L16",children:"OpenIdAuthenticator.SignedIn"})," event is fired. This initiates the authorization process in ",e.jsx(n.a,{href:"https://github.com/0xsequence/sequence-unity/blob/master/Assets/Sequence/SequenceSDK/WaaS/WaaSLogin.cs#L224",children:"WaaSLogin.ConnectToWaaS"}),"."]}),`
...
`]}),`
`,e.jsxs(n.p,{children:["Great! Now, when we send a POST request to our server with a body ",e.jsx(n.a,{href:"https://github.com/0xsequence/sequence-unity/blob/master/Assets/Sequence/SequenceSDK/Relayer/PermissionedMinter.cs#L93",children:"defined in C#"}),", where the ",e.jsx(n.code,{children:"proof"})," is generated by the client sending the minting request. In the Unity SDK this is implemented by the ",e.jsx(n.a,{href:"https://github.com/0xsequence/sequence-unity/blob/master/Assets/Sequence/SequenceSDK/Relayer/MintingRequestProver.cs#L27",children:"MintingRequestProver"}),"."]}),`
...
`,e.jsxs(n.p,{children:["Sequence's Unity SDK provides a very flexible ",e.jsx(n.a,{href:"https://github.com/0xsequence/sequence-unity/blob/master/Assets/Sequence/SequenceSDK/Relayer/TransactionQueuer.cs",children:"transaction queueing system"}),"."]}),`
`,e.jsxs(n.p,{children:["In Jelly Forest, we attached a ",e.jsx(n.a,{href:"https://github.com/0xsequence/sequence-unity/blob/master/Assets/Sequence/SequenceSDK/Relayer/PermissionedMinterTransactionQueuer.cs",children:"PermissionedMinterTransactionQueuer"})," MonoBehaviour to our ",e.jsx(n.code,{children:"SequenceConnector"})," GameObject and ",e.jsx(n.a,{href:"https://github.com/0xsequence/sequence-unity-demo/blob/JellyForest/Scripts/SequenceConnector.cs#L59",children:"grab a reference to it in Awake"}),"."]}),`
