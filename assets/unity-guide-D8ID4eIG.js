...
`,e.jsxs(n.p,{children:["Learn ",e.jsx(n.a,{href:"https://docs.sequence.xyz/solutions/technical-references/wallet-contracts/why",children:"why smart contract wallets here"})]}),`
`,e.jsxs(n.p,{children:["Learn ",e.jsx(n.a,{href:"https://docs.sequence.xyz/solutions/wallets/overview#what-are-the-differences-between-these-options",children:"what an embedded wallet is here"})]}),`
`,e.jsxs(n.p,{children:["This guide will walk you through how we built Jelly Forest and how you too can build your own web3 game using ",e.jsx(n.a,{href:"https://docs.sequence.xyz/sdk/unity/overview/",children:"Sequence's Unity SDK"}),"!"]}),`
...
`,e.jsx(n.li,{children:e.jsx(n.a,{href:"https://docs.sequence.xyz/sdk/unity/installation#package-manager---recommended",children:"Install Sequence's Unity SDK using package manager"})}),`
`,e.jsx(n.li,{children:e.jsx(n.a,{href:"https://docs.sequence.xyz/solutions/builder/getting-started",children:"Sign in to the Sequence Builder Console"})}),`
`,e.jsx(n.li,{children:e.jsx(n.a,{href:"https://docs.sequence.xyz/solutions/builder/project-management",children:"Create a project for your game in the Builder Console"})}),`
`,e.jsxs(n.li,{children:["Setup an ",e.jsx(n.a,{href:"https://docs.sequence.xyz/solutions/builder/in-game-wallet#embedded-wallet-in-builder",children:"Embedded Wallet in the Builder Console"})]}),`
`,e.jsxs(n.li,{children:["In your ",e.jsx(n.code,{children:"SequenceConfig"})," ",e.jsx(n.a,{href:"https://docs.unity3d.com/Manual/class-ScriptableObject.html",children:"scriptable object"})," which you imported via the Samples menu in Package Manager during the ",e.jsx(n.a,{href:"https://docs.sequence.xyz/sdk/unity/installation#package-manager---recommended",children:"installation stage"}),", add your Google and Apple client ids which you added to the Builder as well as your Configuration Key under ",e.jsx(n.code,{children:"WaaSConfigKey"}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsx(n.li,{children:"Don't forget to put your Android and iOS client ids under their respective platforms!"}),`
`]}),`
`]}),`
`,e.jsxs(n.li,{children:["Add your ",e.jsx(n.a,{href:"https://docs.sequence.xyz/solutions/builder/getting-started#step-3-optional-for-development-claim-an-api-access-key",children:"Builder API Key from the Builder Console"})," under ",e.jsx(n.code,{children:"Settings > API Access Keys"})," - you want the ",e.jsx(n.code,{children:"prod"})," key"]}),`
`]}),`
...
`,e.jsx(n.span,{className:"line",children:e.jsx(n.span,{children:"}"})})]})}),`
`,e.jsxs(n.p,{children:["For more information on how auth in Sequence's Embedded Wallet solution works, please see our ",e.jsx(n.a,{href:"https://docs.sequence.xyz/solutions/wallets/embedded-wallet/overview/",children:"docs"})," and ",e.jsx(n.a,{href:"https://sequence.xyz/blog/sequence-embedded-wallets",children:"blog post"}),"."]}),`
