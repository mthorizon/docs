...
`,e.jsx(a,{type:"info",children:e.jsxs(s.p,{children:["A delightful wallet without requiring your users to install anything 😊 ",e.jsx(s.div,{}),` By
integrating `,e.jsx(s.code,{children:"0xsequence"}),`, users may access your dapp without having to install
...
`,e.jsxs(s.span,{className:"line",children:[e.jsx(s.span,{style:{color:"#D73A49","--shiki-dark":"#F47067"},children:"const"}),e.jsx(s.span,{style:{color:"#005CC5","--shiki-dark":"#6CB6FF"},children:" projectAccessKey"}),e.jsx(s.span,{style:{color:"#D73A49","--shiki-dark":"#F47067"},children:" ="}),e.jsx(s.span,{style:{color:"#032F62","--shiki-dark":"#96D0FF"},children:' "<access_key>"'}),e.jsx(s.span,{style:{color:"#24292E","--shiki-dark":"#ADBAC7"},children:";"})]}),`
`,e.jsx(s.span,{className:"line","data-empty-line":!0,children:" "}),`
...
`,e.jsxs(s.p,{children:[`:::tip Check out some example Dapp source code
For a complete examples, see `,e.jsx(s.a,{href:"https://github.com/0xsequence/demo-dapp",children:"Demo-Dapp"})," and ",e.jsx(s.a,{href:"https://github.com/0xsequence/demo-dapp-web3modal",children:"Demo-Dapp-Web3Modal"}),`.
:::`]}),`
`,e.jsxs(s.p,{children:[`:::caution Avoid Browsers Blocking Sequence Popup
Most browsers will block popups if they are called outside of user-triggered event handlers like `,e.jsx(s.code,{children:"onclick"}),", or when it takes too long to process between the user action and the actual window"]}),`
`,e.jsxs(s.p,{children:["Read more about browser popup-blocking ",e.jsx(s.a,{href:"https://javascript.info/popup-windows#popup-blocking",children:"here"}),`.
:::`]}),`
...
`,e.jsx(s.pre,{className:"shiki shiki-themes github-light github-dark-dimmed",style:{backgroundColor:"#fff","--shiki-dark-bg":"#22272e",color:"#24292e","--shiki-dark":"#adbac7"},tabIndex:"0",children:e.jsx(s.code,{children:e.jsx(s.span,{className:"line",children:e.jsx(s.span,{children:"const connectDetails = await wallet.connect(connectOptions)"})})})}),`
...
`,e.jsx("img",{src:"/img/walletconnect/disconnect.png"})]})}function o(n={}){const{wrapper:s}={...l(),...n.components};return s?e.jsx(s,{...n,children:e.jsx(i,{...n})}):i(n)}export{o as default,c as frontmatter};
