...
`,e.jsxs(t.p,{children:["Sequence Auth is an API service that runs on the ",e.jsx(t.a,{href:"https://aws.amazon.com/ec2/nitro/nitro-enclaves/",children:"AWS Nitro Enclaves"})," platform and allows for secure wallet management. Sequence Auth provides a simple way to add account creation, login, session management, and wallet support to your app, enabling applications to provide traditional web experiences (i.e. social login, email login, etc.) while providing access to crypto wallets to interact with smart contracts."]}),`
