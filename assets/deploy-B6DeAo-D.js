import{d as o,j as e,e as r}from"./index-Cwi12Sf2.js";/* empty css                                */const l={title:"Deploy Process V1 for Sequence Wallet Context on New Network",description:"The content provides a detailed guide for deploying the Sequence Wallet V1 Context on a new network. It includes steps to deploy NanoUniversalDeployer and UniversalDeployer2 contracts, along with necessary code snippets and pre-signed transactions."};function s(t){const n={a:"a",code:"code",div:"div",h1:"h1",h3:"h3",header:"header",p:"p",pre:"pre",strong:"strong",...o(),...t.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.header,{children:e.jsxs(n.h1,{id:"deploy-process-v1",children:["Deploy Process V1",e.jsx(n.a,{"aria-hidden":"true",tabIndex:"-1",href:"#deploy-process-v1",children:e.jsx(n.div,{"data-autolink-icon":!0})})]})}),`
