import{d as t,j as e}from"./index-DcwfJ7Jx.js";import{V as i}from"./Video-EovYkTSb.js";const c=void 0;function a(s){const n={a:"a",aside:"aside",code:"code",div:"div",h2:"h2",h3:"h3",h4:"h4",img:"img",li:"li",ol:"ol",p:"p",pre:"pre",span:"span",ul:"ul",...t(),...s.components};return e.jsxs(e.Fragment,{children:[e.jsxs(n.h2,{id:"intro-to-jelly-forest",children:["Intro to Jelly Forest",e.jsx(n.a,{"aria-hidden":"true",tabIndex:"-1",href:"#intro-to-jelly-forest",children:e.jsx(n.div,{"data-autolink-icon":!0})})]}),`
...
`,e.jsxs(n.p,{children:["Learn ",e.jsx(n.a,{href:"https://docs-v2.sequence.xyz/solutions/technical-references/wallet-contracts/why",children:"why smart contract wallets here"})]}),`
`,e.jsxs(n.p,{children:["Learn ",e.jsx(n.a,{href:"https://docs-v2.sequence.xyz/solutions/wallets/overview#what-are-the-differences-between-these-options",children:"what an embedded wallet is here"})]}),`
`,e.jsxs(n.p,{children:["This guide will walk you through how we built Jelly Forest and how you too can build your own web3 game using ",e.jsx(n.a,{href:"https://docs-v2.sequence.xyz/sdk/unity/overview/",children:"Sequence's Unity SDK"}),"!"]}),`
`,e.jsxs(n.h2,{id:"build-a-game-loop",children:["Build a game loop",e.jsx(n.a,{"aria-hidden":"true",tabIndex:"-1",href:"#build-a-game-loop",children:e.jsx(n.div,{"data-autolink-icon":!0})})]}),`
...
`,e.jsxs(n.h2,{id:"integrate-social-sign-in-and-sequences-embedded-wallet-solution",children:["Integrate social sign in and Sequence's Embedded Wallet solution",e.jsx(n.a,{"aria-hidden":"true",tabIndex:"-1",href:"#integrate-social-sign-in-and-sequences-embedded-wallet-solution",children:e.jsx(n.div,{"data-autolink-icon":!0})})]}),`
...
`,e.jsx(n.li,{children:e.jsx(n.a,{href:"https://docs-v2.sequence.xyz/sdk/unity/installation#package-manager---recommended",children:"Install Sequence's Unity SDK using package manager"})}),`
`,e.jsx(n.li,{children:e.jsx(n.a,{href:"https://docs-v2.sequence.xyz/solutions/builder/getting-started",children:"Sign in to the Sequence Builder Console"})}),`
`,e.jsx(n.li,{children:e.jsx(n.a,{href:"https://docs-v2.sequence.xyz/solutions/builder/project-management",children:"Create a project for your game in the Builder Console"})}),`
`,e.jsxs(n.li,{children:["Setup an ",e.jsx(n.a,{href:"https://docs-v2.sequence.xyz/solutions/builder/in-game-wallet#embedded-wallet-in-builder",children:"Embedded Wallet in the Builder Console"})]}),`
`,e.jsxs(n.li,{children:["In your ",e.jsx(n.code,{children:"SequenceConfig"})," ",e.jsx(n.a,{href:"https://docs.unity3d.com/Manual/class-ScriptableObject.html",children:"scriptable object"})," which you imported via the Samples menu in Package Manager during the ",e.jsx(n.a,{href:"https://docs-v2.sequence.xyz/sdk/unity/installation#package-manager---recommended",children:"installation stage"}),", add your Google and Apple client ids which you added to the Builder as well as your Configuration Key under ",e.jsx(n.code,{children:"WaaSConfigKey"}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsx(n.li,{children:"Don't forget to put your Android and iOS client ids under their respective platforms!"}),`
`]}),`
`]}),`
`,e.jsxs(n.li,{children:["Add your ",e.jsx(n.a,{href:"https://docs-v2.sequence.xyz/solutions/builder/getting-started#step-3-optional-for-development-claim-an-api-access-key",children:"Builder API Key from the Builder Console"})," under ",e.jsx(n.code,{children:"Settings > API Access Keys"})," - you want the ",e.jsx(n.code,{children:"prod"})," key"]}),`
`]}),`
...
`,e.jsxs(n.li,{children:["Drag the ",e.jsx(n.code,{children:"LoginPanel"})," prefab into your Scene Hierarchy under the Canvas. This can be found in the Project window under ",e.jsx(n.code,{children:"Packages > Sequence WaaS SDK > SequenceExamples > Prefabs"}),"."]}),`
...
`]}),`
`,e.jsxs(n.p,{children:["The LoginPanel will handle all of the social sign in logic for you. If you're curious how it's implemented, you can checkout the ",e.jsx(n.a,{href:"https://github.com/0xsequence/sequence-unity/blob/master/Assets/SequenceExamples/Scripts/UI/LoginPage.cs",children:"LoginPage"})," and ",e.jsx(n.a,{href:"https://github.com/0xsequence/sequence-unity/blob/master/Assets/SequenceSDK/Authentication/OpenIdAuthenticator.cs",children:"OpenIdAuthenticator"}),` implementations.
...
`,e.jsxs(n.p,{children:["When social sign in is complete, the ",e.jsx(n.a,{href:"https://github.com/0xsequence/sequence-unity/blob/master/Assets/SequenceSDK/Authentication/OpenIdAuthenticator.cs#L15",children:"OpenIdAuthenticator.SignedIn"})," event is fired. This initiates the authorization process in ",e.jsx(n.a,{href:"https://github.com/0xsequence/sequence-unity/blob/master/Assets/SequenceSDK/WaaS/WaaSLogin.cs#L217",children:"WaaSLogin.ConnectToWaaS"}),"."]}),`
...
`,e.jsxs(n.p,{children:["In order to retrieve the wallet, you'll need to subscribe to the ",e.jsx(n.code,{children:"WaaSWallet.OnWaaSWalletCreated"})," event."]}),`
`,e.jsx(n.pre,{className:"shiki shiki-themes github-light github-dark-dimmed",style:{backgroundColor:"#fff","--shiki-dark-bg":"#22272e",color:"#24292e","--shiki-dark":"#adbac7"},tabIndex:"0",children:e.jsxs(n.code,{children:[e.jsx(n.span,{className:"line",children:e.jsx(n.span,{children:"WaaSWallet.OnWaaSWalletCreated += OnWaaSWalletCreatedHandler;"})}),`
`,e.jsx(n.span,{className:"line",children:e.jsx(n.span,{children:"public void OnWaaSWalletCreatedHandler(WaaSWallet wallet) {"})}),`
`,e.jsx(n.span,{className:"line",children:e.jsx(n.span,{children:"  // Do something"})}),`
`,e.jsx(n.span,{className:"line",children:e.jsx(n.span,{children:"}"})})]})}),`
`,e.jsxs(n.p,{children:["We highly recommend you import ",e.jsx(n.code,{children:"SequenceConnector"}),' via the "Useful Scripts" under Samples in the Package Manager page for the "Sequence WaaS SDK".',e.jsx(n.a,{href:"https://github.com/0xsequence/sequence-unity/blob/master/Assets/Samples~/Scripts/SequenceConnector.cs",children:" By default, it contains a lot of helpful starting code"})," and acts as a useful interface to communicate with the SDK. We used it quite heavily ",e.jsx(n.a,{href:"https://github.com/0xsequence/sequence-unity-demo/blob/JellyForest/Scripts/SequenceConnector.cs",children:"in our integration with JellyForest"}),"."]}),`
`,e.jsxs(n.p,{children:["In JellyForest, we also created a ",e.jsx(n.a,{href:"https://github.com/0xsequence/sequence-unity-demo/blob/JellyForest/Scripts/LevelLoader.cs",children:"LevelLoader"})," MonoBehaviour that loads the next scene when the ",e.jsx(n.code,{children:"WaaSWallet.OnWaaSWalletCreated"})," event is fired."]}),`
...
`,e.jsx(n.span,{className:"line",children:e.jsx(n.span,{children:"{"})}),`
`,e.jsx(n.span,{className:"line",children:e.jsx(n.span,{children:"    WaaSWallet.OnWaaSWalletCreated += OnWaaSWalletCreated;"})}),`
`,e.jsx(n.span,{className:"line",children:e.jsx(n.span,{children:"}"})}),`
`,e.jsx(n.span,{className:"line",children:e.jsx(n.span,{})}),`
`,e.jsx(n.span,{className:"line",children:e.jsx(n.span,{children:"private void OnWaaSWalletCreated(WaaSWallet wallet)"})}),`
`,e.jsx(n.span,{className:"line",children:e.jsx(n.span,{children:"{"})}),`
`,e.jsx(n.span,{className:"line",children:e.jsx(n.span,{children:'    SceneManager.LoadScene("MenuScene");'})}),`
`,e.jsx(n.span,{className:"line",children:e.jsx(n.span,{children:"}"})})]})}),`
`,e.jsxs(n.p,{children:["For more information on how auth in Sequence's Embedded Wallet solution works, please see our ",e.jsx(n.a,{href:"https://docs-v2.sequence.xyz/solutions/wallets/embedded-wallet/overview/",children:"docs"})," and ",e.jsx(n.a,{href:"https://sequence.xyz/blog/sequence-embedded-wallets",children:"blog post"}),"."]}),`
`,e.jsxs(n.h2,{id:"deploy-a-collectibles-contract",children:["Deploy a collectibles contract",e.jsx(n.a,{"aria-hidden":"true",tabIndex:"-1",href:"#deploy-a-collectibles-contract",children:e.jsx(n.div,{"data-autolink-icon":!0})})]}),`
...
`]}),`
`,e.jsxs(n.p,{children:["Great! Now, when we send a POST request to our server with a body ",e.jsx(n.a,{href:"https://github.com/0xsequence/sequence-unity/blob/Feature/transactionQueuer/Assets/SequenceSDK/Relayer/PermissionedMinter.cs#L93",children:"defined in C#"}),", where the ",e.jsx(n.code,{children:"proof"})," is generated by the client sending the minting request. In the Unity SDK this is implemented by the ",e.jsx(n.a,{href:"https://github.com/0xsequence/sequence-unity/blob/Feature/transactionQueuer/Assets/SequenceSDK/Relayer/MintingRequestProver.cs#L29",children:"MintingRequestProver"}),"."]}),`
`,e.jsxs(n.h2,{id:"mint-in-game-tokens-to-the-players-inventory",children:["Mint in-game tokens to the player's inventory",e.jsx(n.a,{"aria-hidden":"true",tabIndex:"-1",href:"#mint-in-game-tokens-to-the-players-inventory",children:e.jsx(n.div,{"data-autolink-icon":!0})})]}),`
`,e.jsxs(n.p,{children:["Now that we have our permissioned minter server setup, we need to get the client side (the Made With Unity app) hooked up so that we can start giving our players tokens through gameplay. We can send a request to the permissioned minter using the Unity SDK by calling the ",e.jsx(n.a,{href:"https://github.com/0xsequence/sequence-unity/blob/Feature/transactionQueuer/Assets/SequenceSDK/Relayer/PermissionedMinter.cs#L44",children:"PermissionedMinter.MintToken"})," method."]}),`
...
`,e.jsxs(n.p,{children:["Reading the tokens in a given user's wallet is a complicated process that is made much easier using ",e.jsx(n.a,{href:"https://docs-v2.sequence.xyz/api/indexer/overview",children:"Sequence's Indexer"})," which the ",e.jsx(n.a,{href:"https://docs-v2.sequence.xyz/sdk/unity/read-from-blockchain",children:"Unity SDK implements"}),"."]}),`
...
`,e.jsxs(n.p,{children:["Sequence's Unity SDK provides a very flexible ",e.jsx(n.a,{href:"https://github.com/0xsequence/sequence-unity/blob/Feature/transactionQueuer/Assets/SequenceSDK/Relayer/TransactionQueuer.cs",children:"transaction queueing system"}),"."]}),`
`,e.jsxs(n.p,{children:["In Jelly Forest, we attached a ",e.jsx(n.a,{href:"https://github.com/0xsequence/sequence-unity/blob/Feature/transactionQueuer/Assets/SequenceSDK/Relayer/PermissionedMinterTransactionQueuer.cs",children:"PermissionedMinterTransactionQueuer"})," MonoBehaviour to our ",e.jsx(n.code,{children:"SequenceConnector"})," GameObject and ",e.jsx(n.a,{href:"https://github.com/0xsequence/sequence-unity-demo/blob/JellyForest/Scripts/SequenceConnector.cs#L59",children:"grab a reference to it in Awake"}),"."]}),`
...
`,e.jsx(n.span,{className:"line",children:e.jsx(n.span,{children:"    }"})}),`
`,e.jsx(n.span,{className:"line",children:e.jsx(n.span,{children:"}"})})]})}),`
`,e.jsxs(n.h2,{id:"burn-in-game-tokens-in-exchange-for-others",children:["Burn in-game tokens in exchange for others",e.jsx(n.a,{"aria-hidden":"true",tabIndex:"-1",href:"#burn-in-game-tokens-in-exchange-for-others",children:e.jsx(n.div,{"data-autolink-icon":!0})})]}),`
...
`,e.jsxs(n.h2,{id:"building-the-shop-pages-and-setting-the-minting-requirements",children:["Building the Shop Pages and setting the minting requirements",e.jsx(n.a,{"aria-hidden":"true",tabIndex:"-1",href:"#building-the-shop-pages-and-setting-the-minting-requirements",children:e.jsx(n.div,{"data-autolink-icon":!0})})]}),`
...
`,e.jsx(i,{videoPreviewSrc:"/img/guides/making-of-jelly-forest/ShopItemExtensionScreenshot.png",videoSrc:"/video/unity/ShopItemExtension.mp4"}),`
...
`,e.jsxs(n.h2,{id:"leverage-purchased-items-in-game",children:["Leverage purchased items in-game",e.jsx(n.a,{"aria-hidden":"true",tabIndex:"-1",href:"#leverage-purchased-items-in-game",children:e.jsx(n.div,{"data-autolink-icon":!0})})]}),`
