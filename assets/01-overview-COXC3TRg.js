import{d as a,j as e}from"./index-BCcwr6e0.js";const s={slug:"/unreal-waas-sdk",title:"Introduction",description:"undefined"};function r(i){const n={a:"a",code:"code",div:"div",h1:"h1",h2:"h2",header:"header",li:"li",p:"p",ul:"ul",...a(),...i.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.header,{children:e.jsxs(n.h1,{id:"introduction",children:["Introduction",e.jsx(n.a,{"aria-hidden":"true",tabIndex:"-1",href:"#introduction",children:e.jsx(n.div,{"data-autolink-icon":!0})})]})}),`
`,e.jsxs(n.p,{children:["The Sequence Unreal In-Game Wallet SDK provides full Sequence ",e.jsx(n.a,{href:"/solutions/wallets/embedded-wallet/01-overview",children:"In-Game Wallet"})," and ",e.jsx(n.a,{href:"/api/indexer/01-overview",children:"Indexer"})," integration for games built on the Unreal Framework."]}),`
...
`,e.jsxs(n.p,{children:["Sequence Unreal SDK is only available as a private beta at the moment. To get access, get in touch with ",e.jsx(n.a,{href:"https://sequence.xyz/contact",children:"Sequence BD Team"}),"."]}),`
...
`,e.jsx(n.li,{children:"Unreal 5.2 or later"}),`
`,e.jsx(n.li,{children:"Android"}),`
`,e.jsx(n.li,{children:"iOS"}),`
`,e.jsx(n.li,{children:"PC standalone"}),`
`,e.jsx(n.li,{children:"Mac standalone"}),`
`]})]})}function l(i={}){const{wrapper:n}={...a(),...i.components};return n?e.jsx(n,{...i,children:e.jsx(r,{...i})}):r(i)}export{l as default,s as frontmatter};
