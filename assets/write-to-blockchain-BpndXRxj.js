import{d as s,j as e}from"./index-Cwi12Sf2.js";const o={title:"Blockchain Transaction Writing with WaaS - A Comprehensive Guide",description:"The content provides detailed instructions on writing to a blockchain using the WaaS SDK. It explains how to handle transactions asynchronously, including raw transactions, ERC20, ERC721, and ERC1155 token transfers, as well as complex interactions."};function a(t){const n={a:"a",aside:"aside",code:"code",div:"div",h1:"h1",h2:"h2",h3:"h3",header:"header",li:"li",p:"p",pre:"pre",ul:"ul",...s(),...t.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.header,{children:e.jsxs(n.h1,{id:"write-to-blockchain",children:["Write to Blockchain",e.jsx(n.a,{"aria-hidden":"true",tabIndex:"-1",href:"#write-to-blockchain",children:e.jsx(n.div,{"data-autolink-icon":!0})})]})}),`
...
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-txt",children:`public void OnSendTransactionCompleteHandler(SuccessfulTransactionReturn result) {
    // Do something
}
...
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-txt",children:`_wallet.SendTransaction(
    Chain.Polygon,
...
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-txt",children:`_wallet.SendTransaction(Chain.Polygon, new Sequence.EmbeddedWallet.Transaction[]
    {
        new SendERC20(
            erc20TokenAddress,
            ToAddress,
...
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-txt",children:`ERC20 myToken = new ERC20(myTokenAddress);
`})}),`
...
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-txt",children:`ERC721 myToken = new ERC721(myTokenAddress);
`})}),`
...
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-txt",children:`ERC1155 myToken = new ERC1155(myTokenAddress);
`})}),`
...
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-txt",children:`Transaction[] transactions = new Transaction[]
{
...
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-txt",children:`_wallet.SendTransactionWithFeeOptions(chain, transactions, response.FeeOptions[selectionIndex].FeeOption, response.FeeQuote);
`})}),`
...
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-txt",children:`private async Task WaitForFeeOptionsAndSubmitFirstAvailable(Address toAddress, string amount)
{
...
`})}),`
`,e.jsxs(n.h2,{id:"transaction-queuers",children:["Transaction Queuers",e.jsx(n.a,{"aria-hidden":"true",tabIndex:"-1",href:"#transaction-queuers",children:e.jsx(n.div,{"data-autolink-icon":!0})})]}),`
`,e.jsxs(n.p,{children:["When working with the blockchain, it is important to ",e.jsx(n.a,{href:"/sdk/unity/write-to-blockchain#batch-transactions",children:"batch transactions"})," in order to minimize gas fees. In order to make this easier to do, we've provided a flexible ",e.jsx(n.code,{children:"TransactionQueuer"})," with the SDK that can be configured or extended to suit your needs. To learn more about Building Transaction Heavy Games in Unity and what to consider, please checkout ",e.jsx(n.a,{href:"/guides/building-transaction-heavy-games-with-unity",children:"our guide on the topic"}),"."]}),`
`,e.jsxs(n.p,{children:["When you add a ",e.jsx(n.code,{children:"TransactionQueuer"})," MonoBehaviour to your scene, there are a few config variables you can set."]}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"AutoSubmitTransactions"}),": defaulting to false, enabling this will configure your ",e.jsx(n.code,{children:"TransactionQueuer"})," to automatically submit any queued transactions whenever ",e.jsx(n.code,{children:"ThresholdTimeBetweenTransactionsAddedBeforeSubmittedInSeconds"})," has passed without adding a new transaction to the queue"]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"ThresholdTimeBetweenTransactionsAddedBeforeSubmittedInSeconds"}),": if ",e.jsx(n.code,{children:"AutoSubmitTransactions == true"}),", automatically submit queued transactions if none is added in the past ",e.jsx(n.code,{children:"ThresholdTimeBetweenTransactionsAddedBeforeSubmittedInSeconds"})," seconds"]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"MinimumTimeBetweenTransactionSubmissionsInSeconds"}),": a minimum time between submitting queued transactions. With this, you can call ",e.jsx(n.code,{children:"TransactionQueuer.SubmitTransactions()"})," as often as you want in your code and transactions will not be submitted unless ",e.jsx(n.code,{children:"MinimumTimeBetweenTransactionSubmissionsInSeconds"})," seconds have passed since the last transaction was pushed. Note: if ",e.jsx(n.code,{children:"TransactionQueuer.SubmitTransactions(overrideWait: true)"})," is called with the optional ",e.jsx(n.code,{children:"overrideWait"})," bool flag set to true, the ",e.jsx(n.code,{children:"TransactionQueuer"})," will submit queued transactions regardless of whether or not the ",e.jsx(n.code,{children:"MinimumTimeBetweenTransactionSubmissionsInSeconds"})," has passed."]}),`
`]}),`
`,e.jsxs(n.p,{children:["The ",e.jsx(n.code,{children:"TransactionQueuer"})," exposes a few methods to you:"]}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:["Setup: before calling other methods on a ",e.jsx(n.code,{children:"TransactionQueuer"}),", please call ",e.jsx(n.code,{children:"Setup"})," on it; this will create and cache the required dependancies"]}),`
`,e.jsx(n.li,{children:"Enqueue: add a transaction to the queue"}),`
`,e.jsxs(n.li,{children:["SubmitTransactions(bool overrideWait = false, bool waitForReceipt = true): submit the queued transactions if ",e.jsx(n.code,{children:"MinimumTimeBetweenTransactionSubmissionsInSeconds"})," has passed between last transaction submission by the ",e.jsx(n.code,{children:"TransactionQueuer"}),". If ",e.jsx(n.code,{children:"overrideWait = true"}),", submit any queued transactions immediately. If ",e.jsx(n.code,{children:"waitForReceipt = false"}),", return the ",e.jsx(n.code,{children:"TransactionReturn"})," as soon as we get a response from the WaaS API (note: this is only relevant if the WaaS API times out while waiting for a transaction receipt; if ",e.jsx(n.code,{children:"waitForReceipt = true"}),", we will continually ping a node for a transaction receipt before returning)"]}),`
`,e.jsx(n.li,{children:"ToString(): an override for the typical ToString() function, providing you with better logging support"}),`
`]}),`
`,e.jsx(n.aside,{"data-callout":"warning",children:e.jsxs(n.p,{children:["Don't forget to call ",e.jsx(n.code,{children:"Setup"})," on your ",e.jsx(n.code,{children:"TransactionQueuer"}),"!"]})}),`
`,e.jsxs(n.p,{children:["Currently, the SDK exposes two different inheritors of the ",e.jsx(n.code,{children:"TransactionQueuer"})," class."]}),`
`,e.jsxs(n.h3,{id:"sequencewallettransactionqueuer",children:["SequenceWalletTransactionQueuer",e.jsx(n.a,{"aria-hidden":"true",tabIndex:"-1",href:"#sequencewallettransactionqueuer",children:e.jsx(n.div,{"data-autolink-icon":!0})})]}),`
`,e.jsxs(n.p,{children:["The ",e.jsx(n.code,{children:"SequenceWalletTransactionQueuer"})," allows you to queue up transactions for your user's Sequence Embedded Wallet."]}),`
`,e.jsxs(n.p,{children:["The ",e.jsx(n.code,{children:"SequenceWalletTransactionQueuer"})," expects you to enqueue ",e.jsx(n.code,{children:"IQueueableTransaction"}),"s. This interface is implemented by the ",e.jsx(n.code,{children:"QueuedTokenTransaction"})," class. Please feel free to create other classes implementing the ",e.jsx(n.code,{children:"IQueueableTransaction"})," interface as needed."]}),`
`,e.jsxs(n.h3,{id:"permissionedmintertransactionqueuer",children:["PermissionedMinterTransactionQueuer",e.jsx(n.a,{"aria-hidden":"true",tabIndex:"-1",href:"#permissionedmintertransactionqueuer",children:e.jsx(n.div,{"data-autolink-icon":!0})})]}),`
`,e.jsxs(n.p,{children:["The ",e.jsx(n.code,{children:"PermissionedMinterTransactionQueuer"})," is meant to be used for queueing up transactions that are being submitted by your backend server when receiving a signed message from the player's embedded wallet. It is useful for minting tokens to the player's wallet when interacting with contracts that require permissions for minting (most token contracts)."]}),`
`,e.jsxs(n.p,{children:["The ",e.jsx(n.code,{children:"PermissionedMinterTransactionQueuer"})," expects you to enqueue a ",e.jsx(n.code,{children:"PermissionedMintTransaction"}),", a basic data transfer object specifying the TokenId and Amount to be minted, and optionally an IMinter. If not provided, the ",e.jsx(n.code,{children:"PermissionedMinterTransactionQueuer"})," will default to using the ",e.jsx(n.code,{children:"PermissionedMinter"})," class. The ",e.jsx(n.code,{children:"PermissionedMinter"})," class will be useful for most use cases; it sends a payload in the following format:"]}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-txt",children:`ProofPayload: 
{
...
`})}),`
`,e.jsxs(n.p,{children:["You can then validate this payload on your server and mint the token to the user's address. For an example implementation and setup, please see ",e.jsx(n.a,{href:"/guides/jelly-forest-unity-guide#4-deploy-a-remote-minter",children:"this part of our Jelly Forest guide"}),"."]}),`
`,e.jsx(n.p,{children:"For other use cases, you may want to provide your own implementation of the IMinter class. This allows you to modify the format and information provided in the payload to your server as needed."})]})}function r(t={}){const{wrapper:n}={...s(),...t.components};return n?e.jsx(n,{...t,children:e.jsx(a,{...t})}):a(t)}export{r as default,o as frontmatter};
