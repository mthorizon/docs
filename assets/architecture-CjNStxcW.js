import{d as i,j as e}from"./index-BoTAIcB9.js";const r={title:"Overview",description:"undefined"};function a(n){const t={a:"a",aside:"aside",code:"code",div:"div",em:"em",h1:"h1",h2:"h2",h3:"h3",h4:"h4",header:"header",img:"img",li:"li",ol:"ol",p:"p",strong:"strong",...i(),...n.components};return e.jsxs(e.Fragment,{children:[e.jsx(t.header,{children:e.jsxs(t.h1,{id:"overview",children:["Overview",e.jsx(t.a,{"aria-hidden":"true",tabIndex:"-1",href:"#overview",children:e.jsx(t.div,{"data-autolink-icon":!0})})]})}),`
...
`,e.jsx(t.p,{children:e.jsx(t.img,{src:"/img/diagrams/waas/standalone-overview.drawio.svg",alt:"data-flow-architecture"})}),`
...
Blue: software provided by the partner, yellow: software provided by Sequence but run and managed by the partner, violet: software provided and run by Sequence.`})}),`
...
`,e.jsx(t.p,{children:'The user interacts with the client to "do something" that requires an action on behalf of the wallet (e.g., send some USDC).'}),`
`,e.jsxs(t.p,{children:["The client asks the ",e.jsx(t.code,{children:"waas sdk"})," to generate an intent for such an action; this intent is signed with the session keys of the client."]}),`
`,e.jsxs(t.h4,{id:"2-client-forwards-intent-to-the-backend",children:["2. Client Forwards Intent to the Backend",e.jsx(t.a,{"aria-hidden":"true",tabIndex:"-1",href:"#2-client-forwards-intent-to-the-backend",children:e.jsx(t.div,{"data-autolink-icon":!0})})]}),`
`,e.jsx(t.p,{children:"The intent and its corresponding signature are sent to the partner's backend. The backend authenticates the user using an unspecified mechanism."}),`
`,e.jsx(t.p,{children:"The backend identifies the user without using the intent as the source of truth."}),`
`,e.jsxs(t.h4,{id:"3-backend-forwards-the-intent-to-the-partner-signing-service-pss",children:["3. Backend Forwards the Intent to the Partner Signing Service (PSS)",e.jsx(t.a,{"aria-hidden":"true",tabIndex:"-1",href:"#3-backend-forwards-the-intent-to-the-partner-signing-service-pss",children:e.jsx(t.div,{"data-autolink-icon":!0})})]}),`
`,e.jsx(t.p,{children:"The partner signing service housed in the Nitro Enclave asks the WaaS API to build a transaction for the given intent and then validates that the transaction does not deviate from the original intent."}),`
`,e.jsx(t.p,{children:"Then it uses the partner's hotkey to sign the transaction. It forwards the transaction, intent, and signature to the WaaS API."}),`
`,e.jsxs(t.h4,{id:"4-the-waas-api-collects-the-guard-signature",children:["4. The WaaS API Collects the Guard Signature",e.jsx(t.a,{"aria-hidden":"true",tabIndex:"-1",href:"#4-the-waas-api-collects-the-guard-signature",children:e.jsx(t.div,{"data-autolink-icon":!0})})]}),`
`,e.jsx(t.p,{children:'The WaaS API receives a "half-signed" transaction request, alongside an intent that has been signed by the client.'}),`
`,e.jsx(t.p,{children:"It needs to collect one more signature before being able to relay the transaction, so it calls the guard."}),`
`,e.jsxs(t.h4,{id:"5-the-guard-authenticates-the-user",children:["5. The Guard Authenticates the User",e.jsx(t.a,{"aria-hidden":"true",tabIndex:"-1",href:"#5-the-guard-authenticates-the-user",children:e.jsx(t.div,{"data-autolink-icon":!0})})]}),`
`,e.jsx(t.p,{children:"The guard receives a signature request for a given wallet; it verifies that the intent exists, corresponds to the transaction, and has been signed by a valid session."}),`
`,e.jsx(t.p,{children:"If everything is correct, it signs the transaction."}),`
...
`,e.jsxs(t.p,{children:["The WaaS API relays the transaction and waits for the receipt; the resulting ",e.jsx(t.code,{children:"txHash"})," is piped back to the client/backend."]})]})}function d(n={}){const{wrapper:t}={...i(),...n.components};return t?e.jsx(t,{...n,children:e.jsx(a,{...n})}):a(n)}export{d as default,r as frontmatter};
