...
in javascript`]})}),`
`,e.jsx(i,{type:"tip",children:e.jsxs(n.p,{children:["It's a typical pattern to use offchain compute like a cloudflare worker with a relayer wallet sending transactions, which would be inputted in the account field, more on how to accomplish this ",e.jsx(n.a,{href:"/guides/templates/mint-collectibles-serverless#mint-collectibles-using-a-gasless-serverless-relayer",children:"here"})]})}),`
...
`,e.jsxs(n.p,{children:["Navigate to the ",e.jsx(n.code,{children:"mint"})," card in the ",e.jsx(n.code,{children:"Write Contract"})," section and input your wallet address and amount of tokens in 18 decimals. So for 100 tokens you would input: ",e.jsx(n.code,{children:"100000000000000000000"})]}),`
