...
`,e.jsx(t.p,{children:e.jsx(t.img,{src:"/img/diagrams/waas/auth-overview.drawio.svg",alt:"data-flow-architecture"})}),`
...
`,e.jsxs(t.h4,{id:"3-backend-forwards-the-intent-to-the-dss-dapp-signing-service",children:["3. Backend Forwards the Intent to the DSS (Dapp Signing Service)",e.jsx(t.a,{"aria-hidden":"true",tabIndex:"-1",href:"#3-backend-forwards-the-intent-to-the-dss-dapp-signing-service",children:e.jsx(t.div,{"data-autolink-icon":!0})})]}),`
`,e.jsx(t.p,{children:"The DSS asks the WaaS API to build a transaction for the given intent and then validates that the transaction does not deviate from the original intent."}),`
