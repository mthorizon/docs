...
`]}),`
`,e.jsxs(n.p,{children:["As a way of future proofing we recommend installing Visual Studio 2022 in accordance with ",e.jsx(n.a,{href:"https://dev.epicgames.com/documentation/en-us/unreal-engine/setting-up-visual-studio-development-environment-for-cplusplus-projects-in-unreal-engine",children:"these docs"})," as Unreal 5.4 and onward will be dropping support for Visual Studio 2019."]})]})}function d(r={}){const{wrapper:n}={...o(),...r.components};return n?e.jsx(n,{...r,children:e.jsx(i,{...r})}):i(r)}export{d as default,a as frontmatter};
