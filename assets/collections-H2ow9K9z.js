import{d as l,j as e}from"./index-Bygo7joG.js";const a={title:"Collections in Sequence Builder",description:"undefined"};function i(n){const t={a:"a",code:"code",div:"div",h1:"h1",h2:"h2",h4:"h4",header:"header",img:"img",li:"li",ol:"ol",p:"p",...l(),...n.components};return e.jsxs(e.Fragment,{children:[e.jsx(t.header,{children:e.jsxs(t.h1,{id:"collections-in-sequence-builder",children:["Collections in Sequence Builder",e.jsx(t.a,{"aria-hidden":"true",tabIndex:"-1",href:"#collections-in-sequence-builder",children:e.jsx(t.div,{"data-autolink-icon":!0})})]})}),`
...
`,e.jsx(t.p,{children:"Media and metadata is saved to Sequence servers where certain functionality allows you to have control over updates and public / private viewing of your collection information"}),`
`,e.jsx(t.p,{children:"The following functions are possible:"}),`
`,e.jsxs(t.ol,{children:[`
`,e.jsxs(t.li,{children:[e.jsx(t.a,{href:"/solutions/builder/collections#1-create-a-collection",children:"Create Collection"}),": Create a new collection and specify details"]}),`
`,e.jsxs(t.li,{children:[e.jsx(t.a,{href:"/solutions/builder/collections#2-link-a-contract",children:"Link a Contract"}),":  Deploy and link a contract"]}),`
`,e.jsxs(t.li,{children:[e.jsx(t.a,{href:"/solutions/builder/collections#3-create-a-collectible",children:"Create Collectible"}),": Upload media artwork as an image and encode properties"]}),`
`,e.jsxs(t.li,{children:[e.jsx(t.a,{href:"/solutions/builder/collections#4-update-info-in-settings",children:"Upate Settings"}),": Update collection details in settings"]}),`
`,e.jsxs(t.li,{children:[e.jsx(t.a,{href:"/solutions/builder/collections#5-reference-metadata-token-uri",children:"(Optional) Reference Metadata Token URIs"}),": Reference token metadata base URI for any collectible contract"]}),`
`]}),`
...
`,e.jsx(t.p,{children:e.jsx(t.img,{src:"/img/builder/builder_create_collection.png",alt:"create collection"})}),`
...
`,e.jsx(t.p,{children:e.jsx(t.img,{src:"/img/builder/builder_create_collection_input_details.png",alt:"add details to collection"})}),`
...
`,e.jsx(t.p,{children:e.jsx(t.img,{src:"/img/builder/builder_collections_link_contract.png",alt:"link a contract"})}),`
`,e.jsxs(t.p,{children:["Then select the ",e.jsx(t.code,{children:"+ Deploy new contract"})]}),`
`,e.jsx(t.p,{children:e.jsx(t.img,{src:"/img/builder/builder_collection_deploy_contract.png",alt:"deploy a contract"})}),`
`,e.jsx(t.p,{children:"Select your contract type or upload your own"}),`
`,e.jsx(t.p,{children:e.jsx(t.img,{src:"/img/builder/builder_select_contract_type.png",alt:"contract type"})}),`
`,e.jsxs(t.p,{children:["And complete your contract details, specifying the ",e.jsx(t.code,{children:"Network"}),", ",e.jsx(t.code,{children:"Contract Name"}),", and ",e.jsx(t.code,{children:"Royalties"}),", and finally select ",e.jsx(t.code,{children:"Deploy Contract"})," to then complete the transaction signing in the Sequence popup."]}),`
`,e.jsx(t.p,{children:e.jsx(t.img,{src:"/img/builder/builder_deploy_contract_details.png",alt:"contract details"})}),`
...
`,e.jsx(t.p,{children:e.jsx(t.img,{src:"/img/builder/builder_read_base_uri.png",alt:"read base uri"})}),`
...
`,e.jsx(t.p,{children:e.jsx(t.img,{src:"/img/builder/builder_collections_add_a_collectible.png",alt:"add a collectible"})}),`
...
`,e.jsx(t.p,{children:e.jsx(t.img,{src:"/img/builder/builder_collections_update_art_and_details.png",alt:"update collectible details"})}),`
...
`,e.jsx(t.p,{children:e.jsx(t.img,{src:"/img/builder/builder_collection_add_propery.png",alt:"add a property"})}),`
`,e.jsx(t.p,{children:"Assigning the key and value to each property"}),`
`,e.jsx(t.p,{children:e.jsx(t.img,{src:"/img/builder/builder_collections_assign_properties.png",alt:"asign properties"})}),`
`,e.jsx(t.p,{children:"Complete the prior steps until you get your final result of a collectible added to a collection"}),`
`,e.jsx(t.p,{children:e.jsx(t.img,{src:"/img/builder/builder_collections_final_result_of_collectible.png",alt:"final result of collectible added"})}),`
...
`,e.jsx(t.p,{children:e.jsx(t.img,{src:"/img/builder/builder_collections_access_settings.png",alt:"settings"})}),`
...
`,e.jsx(t.p,{children:e.jsx(t.img,{src:"/img/builder/builder_collections_update_info.png",alt:"settings"})}),`
...
`,e.jsxs(t.p,{children:["Currently in order to ",e.jsx(t.code,{children:"Link Contract"})," you can't use predeployed contracts, but you can read the ",e.jsx(t.code,{children:"Token Metadata URI"})," from the Collection to set your existing contracts' ",e.jsx(t.code,{children:"setBaseMetadataURI"}),". The URI can be retrieved by accessing ",e.jsx(t.code,{children:"Metadata URIs"})," purple button"]}),`
`,e.jsx(t.p,{children:e.jsx(t.img,{src:"/img/builder/builder_collections_metadata_uris.png",alt:"access metadata uris"})}),`
...
`,e.jsx(t.p,{children:e.jsx(t.img,{src:"/img/builder/builder_collections_token_metadata_uri.png",alt:"copy metadata uris"})})]})}function o(n={}){const{wrapper:t}={...l(),...n.components};return t?e.jsx(t,{...n,children:e.jsx(i,{...n})}):i(n)}export{o as default,a as frontmatter};
