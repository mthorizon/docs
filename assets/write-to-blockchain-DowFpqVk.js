import{d as i,j as e}from"./index-D9wOWnfc.js";const l={title:"Blockchain Transaction Writing with WaaS - A Comprehensive Guide",description:"The content provides detailed instructions on writing to a blockchain using the WaaS SDK. It explains how to handle transactions asynchronously, including raw transactions, ERC20, ERC721, and ERC1155 token transfers, as well as complex interactions."};function a(s){const n={a:"a",code:"code",div:"div",h1:"h1",h2:"h2",h3:"h3",header:"header",p:"p",pre:"pre",span:"span",...i(),...s.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.header,{children:e.jsxs(n.h1,{id:"write-to-blockchain",children:["Write to Blockchain",e.jsx(n.a,{"aria-hidden":"true",tabIndex:"-1",href:"#write-to-blockchain",children:e.jsx(n.div,{"data-autolink-icon":!0})})]})}),`
...
`,e.jsx(n.span,{className:"line",children:e.jsx(n.span,{children:"}"})})]})})]})}function c(s={}){const{wrapper:n}={...i(),...s.components};return n?e.jsx(n,{...s,children:e.jsx(a,{...s})}):a(s)}export{c as default,l as frontmatter};
