import{d as i,j as e}from"./index-CEELqpEI.js";const r={title:"Analytics in Sequence Builder",description:"undefined"};function a(n){const t={a:"a",aside:"aside",div:"div",em:"em",h1:"h1",h2:"h2",h4:"h4",header:"header",img:"img",p:"p",strong:"strong",...i(),...n.components};return e.jsxs(e.Fragment,{children:[e.jsx(t.header,{children:e.jsxs(t.h1,{id:"analytics-in-sequence-builder",children:["Analytics in Sequence Builder",e.jsx(t.a,{"aria-hidden":"true",tabIndex:"-1",href:"#analytics-in-sequence-builder",children:e.jsx(t.div,{"data-autolink-icon":!0})})]})}),`
...
`,e.jsx(t.p,{children:e.jsx(t.img,{src:"/img/builder/builder_analytics_txn_requests.png",alt:"Sequence Builder analytics transaction requests"})})]})}function d(n={}){const{wrapper:t}={...i(),...n.components};return t?e.jsx(t,{...n,children:e.jsx(a,{...n})}):a(n)}export{d as default,r as frontmatter};
