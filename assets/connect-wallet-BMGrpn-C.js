...
`,e.jsxs(n.p,{children:[":::info A delightful wallet without requiring your users to install anything ",e.jsx(n.div,{}),`
By integrating `,e.jsx(n.code,{children:"0xsequence"}),`, users may access your dapp without having to install any special extensions,
...
`,e.jsxs(n.span,{className:"line",children:[e.jsx(n.span,{style:{color:"#D73A49","--shiki-dark":"#F47067"},children:"const"}),e.jsx(n.span,{style:{color:"#005CC5","--shiki-dark":"#6CB6FF"},children:" projectAccessKey"}),e.jsx(n.span,{style:{color:"#D73A49","--shiki-dark":"#F47067"},children:" ="}),e.jsx(n.span,{style:{color:"#032F62","--shiki-dark":"#96D0FF"},children:" '<access_key>'"})]}),`
`,e.jsx(n.span,{className:"line","data-empty-line":!0,children:" "}),`
...
`,e.jsx("img",{src:"/img/walletconnect/disconnect.png",alt:"A user disconnecting from the app using Wallet Connect"})]})}function t(s={}){const{wrapper:n}={...l(),...s.components};return n?e.jsx(n,{...s,children:e.jsx(i,{...s})}):i(s)}export{t as default,r as frontmatter};
