import{d as a,j as e}from"./index-DmSPe94a.js";const t={title:"Sequence - Web3 Gaming Platform - Unity SDK Setup",description:"Documentation for Unity SDK setup for the Sequence infrastructure stack for web3 gaming."};function s(i){const n={a:"a",aside:"aside",code:"code",div:"div",em:"em",h1:"h1",h2:"h2",header:"header",p:"p",pre:"pre",span:"span",strong:"strong",...a(),...i.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.header,{children:e.jsxs(n.h1,{id:"setup",children:["Setup",e.jsx(n.a,{"aria-hidden":"true",tabIndex:"-1",href:"#setup",children:e.jsx(n.div,{"data-autolink-icon":!0})})]})}),`
`,e.jsxs(n.h2,{id:"configini",children:["Config.ini",e.jsx(n.a,{"aria-hidden":"true",tabIndex:"-1",href:"#configini",children:e.jsx(n.div,{"data-autolink-icon":!0})})]}),`
...
`,e.jsx(n.p,{children:e.jsxs(n.em,{children:["Note: Make sure to get the WaaS keys from ",e.jsx(n.strong,{children:"Production Mode"}),"."]})}),`
...
`,e.jsx(n.aside,{"data-callout":"warning",children:e.jsx(n.p,{children:"Only alphanumeric characters are accepted!"})})]})}function c(i={}){const{wrapper:n}={...a(),...i.components};return n?e.jsx(n,{...i,children:e.jsx(s,{...i})}):s(i)}export{c as default,t as frontmatter};
