import{d as i,j as e}from"./index-DJVAUhEL.js";const r={title:"SequenceEthereum Client Methods and Usage",description:"Use SequenceEthereum to create a Client and utilize our Node Gateway service for RPC requests."};function t(a){const n={a:"a",aside:"aside",code:"code",div:"div",h1:"h1",h2:"h2",h3:"h3",header:"header",p:"p",pre:"pre",...i(),...a.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.header,{children:e.jsxs(n.h1,{id:"clients",children:["Clients",e.jsx(n.a,{"aria-hidden":"true",tabIndex:"-1",href:"#clients",children:e.jsx(n.div,{"data-autolink-icon":!0})})]})}),`
