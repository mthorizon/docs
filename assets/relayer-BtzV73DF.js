import{u as r,j as e}from"./index-CrGpAx-R.js";const i={title:"Relayer",description:"undefined"};function t(a){const n={a:"a",aside:"aside",div:"div",h1:"h1",header:"header",li:"li",p:"p",ul:"ul",...r(),...a.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.header,{children:e.jsxs(n.h1,{id:"relayer",children:["Relayer",e.jsx(n.a,{"aria-hidden":"true",tabIndex:"-1",href:"#relayer",children:e.jsx(n.div,{"data-autolink-icon":!0})})]})}),`
`,e.jsx(n.aside,{"data-callout":"note",children:e.jsx(n.p,{children:e.jsx(n.a,{href:"https://0xsequence.redoc.ly/tag/relayer",children:"Relayer API documentation and testing"})})}),`
...
`,e.jsx(n.li,{children:"Fire + forget model -- easily send transactions to the relayer, which will ensure fast delivery"}),`
