...
`,e.jsx(n.p,{children:"In this guide, we'll walk you through the process of creating your own in-game currency through deploying and minting from an ERC-20 contract."}),`
...
`,e.jsxs(n.h4,{id:"what-is-an-erc-20-token",children:["What is an ERC-20 token?",e.jsx(n.a,{"aria-hidden":"true",tabIndex:"-1",href:"#what-is-an-erc-20-token",children:e.jsx(n.div,{"data-autolink-icon":!0})})]}),`
`,e.jsxs(n.p,{children:["An ERC-20 token is a digital coin - what makes it special is that it follows a ",e.jsx(n.a,{href:"https://ethereum.org/en/developers/docs/standards/tokens/erc-20/",children:"set of rules called ERC-20"}),", making it easy to use in different places on the internet. These tokens often represent value or be used for specific purposes. Unlike the other common token - NFT's, these tokens are fungible."]}),`
...
`,e.jsx(n.p,{children:"Fungible tokens (like ERC-20 tokens) are interchangeable, and each unit is the same as every other unit, just like dollars or euros. They can easily be split or combined into different quantities."}),`
`,e.jsx(n.p,{children:"Non-fungible tokens (like ERC-721 tokens) represent unique items with individual properties, such as digital art or collectibles. Each token is distinct and not directly exchangeable with another on a like-for-like basis."}),`
...
`,e.jsxs(n.h2,{id:"step-4-deploy-you-contract",children:["Step 4: Deploy you contract",e.jsx(n.a,{"aria-hidden":"true",tabIndex:"-1",href:"#step-4-deploy-you-contract",children:e.jsx(n.div,{"data-autolink-icon":!0})})]}),`
...
`,e.jsxs(n.p,{children:["Navigate to the ",e.jsx(n.code,{children:"mint"})," card in the ",e.jsx(n.code,{children:"Write Contract"})," section and input your wallet address and amount of tokens in 18 decimals. So for 100 tokens you would input: ",e.jsx(n.code,{children:"100000000000000000000"})," with 18 additional trailing zeros"]}),`
