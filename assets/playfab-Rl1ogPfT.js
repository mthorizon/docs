...
`,e.jsx(n.aside,{"data-callout":"warning",children:e.jsxs(n.p,{children:["Don't forget to ",e.jsx(n.a,{href:"/solutions/builder/embedded-wallet/playfab-configuration",children:"configure PlayFab in the Builder"}),"!"]})})]})}function s(i={}){const{wrapper:n}={...a(),...i.components};return n?e.jsx(n,{...i,children:e.jsx(t,{...i})}):t(i)}export{s as default,r as frontmatter};
