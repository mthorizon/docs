...
`,e.jsx(n.p,{children:"Click Next, and then Done to complete the configuration. Finally don't forget to click Continue to save the changes."}),`
...
`,e.jsx(n.p,{children:"As mentioned above, for an iOS application, you can use the Bundle ID you created as your Client ID in Sequence Builder. For a web application, you can use the Identifier you created as your Client ID in Sequence Builder."})]})}function c(i={}){const{wrapper:n}={...r(),...i.components};return n?e.jsx(n,{...i,children:e.jsx(o,{...i})}):o(i)}export{c as default,d as frontmatter};
