import{d as r,j as e,e as a}from"./index-C4MM660i.js";import"./HomePage.css.js.vanilla-l0sNRNKZ.js";const d={title:"Contract Deployment",description:"undefined"};function i(n){const t={a:"a",div:"div",h1:"h1",h2:"h2",h4:"h4",header:"header",li:"li",p:"p",strong:"strong",ul:"ul",...r(),...n.components};return e.jsxs(e.Fragment,{children:[e.jsx(t.header,{children:e.jsxs(t.h1,{id:"contract-deployment",children:["Contract Deployment",e.jsx(t.a,{"aria-hidden":"true",tabIndex:"-1",href:"#contract-deployment",children:e.jsx(t.div,{"data-autolink-icon":!0})})]})}),`
...
`,e.jsxs(t.li,{children:["v1: ",e.jsx(t.a,{href:"/solutions/technical-references/internals/v1/01-deploy",children:"Deploy v1 Contracts"})]}),`
`,e.jsxs(t.li,{children:["v2: ",e.jsx(t.a,{href:"/solutions/technical-references/internals/v2/01-deploy",children:"Deploy v2 Contracts"})]}),`
`]})]})}function c(n={}){const{wrapper:t}={...r(),...n.components};return t?e.jsx(t,{...n,children:e.jsx(i,{...n})}):i(n)}export{c as default,d as frontmatter};
