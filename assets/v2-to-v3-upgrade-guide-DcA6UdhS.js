import{d as a,j as e}from"./index-BtBYpIYa.js";const r={title:"Upgrading from v2 to v3",description:"undefined"};function s(i){const n={a:"a",code:"code",div:"div",h1:"h1",h2:"h2",header:"header",li:"li",ol:"ol",p:"p",pre:"pre",span:"span",...a(),...i.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.header,{children:e.jsxs(n.h1,{id:"upgrading-from-v2-to-v3",children:["Upgrading from v2 to v3",e.jsx(n.a,{"aria-hidden":"true",tabIndex:"-1",href:"#upgrading-from-v2-to-v3",children:e.jsx(n.div,{"data-autolink-icon":!0})})]})}),`
...
`,e.jsx(n.pre,{className:"shiki shiki-themes github-light github-dark-dimmed",style:{backgroundColor:"#fff","--shiki-dark-bg":"#22272e",color:"#24292e","--shiki-dark":"#adbac7"},tabIndex:"0",children:e.jsxs(n.code,{children:[e.jsx(n.span,{className:"line",children:e.jsx(n.span,{children:"using Sequence.WaaS;"})}),`
`,e.jsx(n.span,{className:"line",children:e.jsx(n.span,{children:"using Sequence.WaaS.Authentication;"})}),`
`,e.jsx(n.span,{className:"line",children:e.jsx(n.span,{children:"using SequenceSDK.WaaS;"})})]})}),`
`,e.jsx(n.p,{children:"Replace this with"}),`
`,e.jsx(n.pre,{className:"shiki shiki-themes github-light github-dark-dimmed",style:{backgroundColor:"#fff","--shiki-dark-bg":"#22272e",color:"#24292e","--shiki-dark":"#adbac7"},tabIndex:"0",children:e.jsx(n.code,{children:e.jsx(n.span,{className:"line",children:e.jsx(n.span,{children:"using Sequence.EmbeddedWallet;"})})})}),`
...
`]}),`
`]})]})}function l(i={}){const{wrapper:n}={...a(),...i.components};return n?e.jsx(n,{...i,children:e.jsx(s,{...i})}):s(i)}export{l as default,r as frontmatter};
