import{d as a,j as e}from"./index-BkGOFoCB.js";const o={title:"Guest Module",description:"undefined"};function s(n){const t={a:"a",div:"div",h1:"h1",h2:"h2",header:"header",p:"p",...a(),...n.components};return e.jsxs(e.Fragment,{children:[e.jsx(t.header,{children:e.jsxs(t.h1,{id:"guest-module",children:["Guest Module",e.jsx(t.a,{"aria-hidden":"true",tabIndex:"-1",href:"#guest-module",children:e.jsx(t.div,{"data-autolink-icon":!0})})]})}),`
...
The batched transactions are processed by the Guest Module.`})]})}function d(n={}){const{wrapper:t}={...a(),...n.components};return t?e.jsx(t,{...n,children:e.jsx(s,{...n})}):s(n)}export{d as default,o as frontmatter};
