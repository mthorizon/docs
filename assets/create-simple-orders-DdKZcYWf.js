...
`,e.jsxs(s.p,{children:["In order to accept an existing request, one would need to use one of the ",e.jsx(s.code,{children:"get"})," requests endpoints (like ",e.jsx(s.a,{href:"/solutions/marketplaces/orderbook/examples/get-top-orders",children:"getTopOrders"}),") to acquire a ",e.jsx(s.code,{children:"orderId"})," inputted into the ",e.jsx(s.code,{children:"requestId"})," parameter to submit a transaction, with a prior transaction of approving the currency for the request."]}),`
