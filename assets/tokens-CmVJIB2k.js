import{d as a,j as e}from"./index-Clt8kNMW.js";const i={title:"Interacting with Tokens and Ownable Contracts - Wrappers and ABIs",description:"The content provides information on using `ERC20`, `ERC721`, and `ERC1155` wrappers of the Contract class with pre-defined ABIs for interacting with tokens."};function r(t){const n={a:"a",code:"code",div:"div",h1:"h1",header:"header",p:"p",pre:"pre",...a(),...t.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.header,{children:e.jsxs(n.h1,{id:"tokens",children:["Tokens",e.jsx(n.a,{"aria-hidden":"true",tabIndex:"-1",href:"#tokens",children:e.jsx(n.div,{"data-autolink-icon":!0})})]})}),`
