import{d as s,j as e}from"./index-Dnc-T7t0.js";const d={title:"Upgrading from v2 to v3",description:"undefined"};function a(i){const n={a:"a",code:"code",div:"div",h1:"h1",h2:"h2",header:"header",li:"li",ol:"ol",p:"p",pre:"pre",...s(),...i.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.header,{children:e.jsxs(n.h1,{id:"upgrading-from-v2-to-v3",children:["Upgrading from v2 to v3",e.jsx(n.a,{"aria-hidden":"true",tabIndex:"-1",href:"#upgrading-from-v2-to-v3",children:e.jsx(n.div,{"data-autolink-icon":!0})})]})}),`
...
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-txt",children:`using Sequence.WaaS;
using Sequence.WaaS.Authentication;
using SequenceSDK.WaaS;
`})}),`
`,e.jsx(n.p,{children:"Replace this with"}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-txt",children:`using Sequence.EmbeddedWallet;
`})}),`
...
`]}),`
`]})]})}function l(i={}){const{wrapper:n}={...s(),...i.components};return n?e.jsx(n,{...i,children:e.jsx(a,{...i})}):a(i)}export{l as default,d as frontmatter};
